...
<http://www.gnu.org/licenses/>.  */
	...
	echo "Script returned: " . $coursesJSON . "<br><br> JSON: ";
	print_r($courses);
...
<html lang="en">
    <head>
        <title>CSF Registration Debug</title>
        <meta charset="utf-8">
    ...
    <body>
        <header>
            <h1>Aeries Parent Portal Link Debug</h1>
            <hr>
        </header>
        <form action="eligibility_debug.php" method="post">
            <table>
                <th></th>
                <th></th>
                <tr>
